...
class Upload
{
    ...
    public function imageEncrypted(string $uuid, mixed $file, string $publicKey, array $options = []): array
    {
        ...
        // The server's "default" encryption mode receives the encrypted envelope as a
        // multipart file (it reads request.file(), then JSON.parses the bytes and decrypts
        // with the server private key). It is NOT a JSON request body.
        $headers = [
